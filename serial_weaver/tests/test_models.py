...
# to be set.
from serial_weaver.tests.models import CustomerModel
from serial_weaver import GLOBAL_DATA_STORE as data_store
from serial_weaver.utils import generate_from_file, load_file_to_dict
from serial_weaver.tests.utils import get_customer_model_records_for_assertion, get_customer_data_for_assertion


### FIXTURES ###
@pytest.fixture
def products_yaml_file():
    return "serial_weaver/tests/mocked_data/products.yaml"


@pytest.fixture
def customers_json_file():
    return "serial_weaver/tests/mocked_data/customers.json"


@pytest.fixture
def customers_toml_file():
    return "serial_weaver/tests/mocked_data/customers.toml"


@pytest.fixture
def customers_yaml_file():
    return "serial_weaver/tests/mocked_data/customers.yaml"


@pytest.fixture
def yml_customers_yaml_file():
    return "serial_weaver/tests/mocked_data/yml_customers.yaml"


@pytest.fixture
def rendered_customers_txt_file():
    return "serial_weaver/tests/mocked_data/rendered_customers.txt"
...
def test_generate_models(products_yaml_file, customers_json_file):
    ...
    # os.environ["MODELS_MODULES"] = "serial_weaver.tests.models"
...
def test_rendering(rendered_customers_txt_file):
    os.environ["TEMPLATES_DIR"] = "serial_weaver/tests/templates"

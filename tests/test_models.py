...
def products_yaml_file():
    return "tests/mocked_data/products.yaml"
...
def customers_toml_file():
    return "tests/mocked_data/customers.toml"


@pytest.fixture
def customers_yaml_file():
    return "tests/mocked_data/customers.yaml"


@pytest.fixture
def yml_customers_yaml_file():
    return "tests/mocked_data/yml_customers.yaml"


@pytest.fixture
def rendered_customers_txt_file():
    return "tests/mocked_data/rendered_customers.txt"
...
def test_generate_models(products_yaml_file, customers_json_file):
    ...
    # os.environ["MODELS_MODULES"] = "tests.models"
